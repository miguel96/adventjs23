...
gamesPotential().then((resp)=>console.log(`gamesPotential: ${resp}`)).catch(console.error);
possibleGames().then((resp)=>console.log(`possibleGames: ${resp}`)).catch(console.error);
